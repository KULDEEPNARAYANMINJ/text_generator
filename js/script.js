...
***/
var quotes = [
  { quote: "|||kuldeep the great|||I have been studying the traits and dispositions of the 'lower animals' (so called) and contrasting them with the traits and dispositions of man. I find the result humiliating to me.", source: "|||kuldeep the great|||", citation: "Letters From Earth", tags: ['|||kuldeep the great|||', '#FreightTwain']},
  { quote: 'Go so far away that you stop being afraid of not coming back.', source: '|||kuldeep the great|||', citation: 'I Am an Emotional Creature: The Secret Life of Girls Around the World', year: 2010},
  { quote: "Live Long and Prosper", source: "|||kuldeep the great|||", citiation: "|||kuldeep the great|||", year: '1967', tags: ['#Trekkies', '#Vulcan', '#Space']},
  { quote: "Yadda Yadda Yadda", source: "|||kuldeep the great|||", year: "1997", tags: ['#Yadda', '#NoSoupForYou']},
